...
namespace Fonet.Fo.Properties
{
    internal class GenericBoolean : EnumProperty.Maker
    {
        ...
        protected static readonly EnumProperty s_propTRUE = new EnumProperty((int)Enums.TRUE);

        protected static readonly EnumProperty s_propFALSE = new EnumProperty((int)Enums.FALSE);

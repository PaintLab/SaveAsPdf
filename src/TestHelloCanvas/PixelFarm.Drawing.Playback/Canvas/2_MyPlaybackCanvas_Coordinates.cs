...
{
    partial class MyPlaybackCanvas
    {
        int left;
        int top;
        int right;
        ...
        public override bool PushClipAreaRect(int width, int height, ref Rectangle updateArea)
        {
            ...
            Rectangle intersectResult = Rectangle.Intersect(
                new Rectangle(updateArea.Left, updateArea.Top, updateArea.Right, updateArea.Bottom),
            ...
            {
                updateArea = intersectResult;// Conv.ToRect(intersectResult);
